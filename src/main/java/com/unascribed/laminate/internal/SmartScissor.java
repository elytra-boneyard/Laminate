...
/**
 * Implements a smarter scissor designed for nesting. Essentially makes
 * setting a scissor box clip that box to the current scissor box.
 */
public final class SmartScissor {
	...
	public static void setFromComponentCoordinates(int x, int y, int width, int height) {
		ScaledResolution res = LaminateInternal.createScaledResolution();
